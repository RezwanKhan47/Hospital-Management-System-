...
class NeurologistData extends StatefulWidget {
  const NeurologistData({super.key});

  @override
  _NeurologistDataState createState() => _NeurologistDataState();
}

class _NeurologistDataState extends State<NeurologistData> {
  List<Map<String, dynamic>> cartItems = []; // List to store cart items

  Future<List<dynamic>> allPerson() async {
    final uri = Uri.parse(
        "http://192.168.0.109/image_upload_php_mysql/viewAll_neurologist.php");

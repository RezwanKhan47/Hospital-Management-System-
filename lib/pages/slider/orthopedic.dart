...
class OrthopedicData extends StatefulWidget {
  const OrthopedicData({super.key});

  @override
  _OrthopedicDataState createState() => _OrthopedicDataState();
}

class _OrthopedicDataState extends State<OrthopedicData> {
  List<Map<String, dynamic>> cartItems = []; // List to store cart items

  Future<List<dynamic>> allPerson() async {
    final uri = Uri.parse(
        "http://192.168.0.109/image_upload_php_mysql/viewAll _orthopedic.php");

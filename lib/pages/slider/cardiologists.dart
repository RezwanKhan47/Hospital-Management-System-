...
import 'package:hospital_managment_system/pages/cart.dart';
import 'package:http/http.dart' as http;

class CardiologistData extends StatefulWidget {
  const CardiologistData({super.key});

  @override
  _CardiologistDataState createState() => _CardiologistDataState();
}

class _CardiologistDataState extends State<CardiologistData> {
  List<Map<String, dynamic>> cartItems = []; // List to store cart items

  Future<List<dynamic>> allPerson() async {
    final uri = Uri.parse(
        "http://192.168.0.109/image_upload_php_mysql/viewAll _cardiologists.php");
